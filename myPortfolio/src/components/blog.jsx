			...
			<div className="colorlib-narrow-content">
				...
				<div className="row">
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small>May 26, 2021 </small> | <small> Web Design </small> | <small> <i className="icon-bubble3" /> 4</small></span>
					...
					<div className="blog-entry">
						...
						<div className="desc">
							<span><small>May 26,2021</small> | <small> Inspiration </small> | <small> <i className="icon-bubble3" /> 4</small></span>
